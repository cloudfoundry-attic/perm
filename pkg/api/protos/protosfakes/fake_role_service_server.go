...
type FakeRoleServiceServer struct {
	...
	AssignRoleToGroupStub        func(context.Context, *protos.AssignRoleToGroupRequest) (*protos.AssignRoleToGroupResponse, error)
	assignRoleToGroupMutex       sync.RWMutex
	assignRoleToGroupArgsForCall []struct {
		arg1 context.Context
		arg2 *protos.AssignRoleToGroupRequest
	}
	...
	UnassignRoleFromGroupStub        func(context.Context, *protos.UnassignRoleFromGroupRequest) (*protos.UnassignRoleFromGroupResponse, error)
	unassignRoleFromGroupMutex       sync.RWMutex
	unassignRoleFromGroupArgsForCall []struct {
		arg1 context.Context
		arg2 *protos.UnassignRoleFromGroupRequest
	}
...
func (fake *FakeRoleServiceServer) AssignRoleToGroup(arg1 context.Context, arg2 *protos.AssignRoleToGroupRequest) (*protos.AssignRoleToGroupResponse, error) {
	...
	fake.recordInvocation("AssignRoleToGroup", []interface{}{arg1, arg2})
	fake.assignRoleToGroupMutex.Unlock()
	if fake.AssignRoleToGroupStub != nil {
		return fake.AssignRoleToGroupStub(arg1, arg2)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
...
func (fake *FakeRoleServiceServer) AssignRoleToGroupCallCount() int {
	fake.assignRoleToGroupMutex.RLock()
	defer fake.assignRoleToGroupMutex.RUnlock()
	return len(fake.assignRoleToGroupArgsForCall)
}

func (fake *FakeRoleServiceServer) AssignRoleToGroupArgsForCall(i int) (context.Context, *protos.AssignRoleToGroupRequest) {
	fake.assignRoleToGroupMutex.RLock()
	defer fake.assignRoleToGroupMutex.RUnlock()
	return fake.assignRoleToGroupArgsForCall[i].arg1, fake.assignRoleToGroupArgsForCall[i].arg2
}

func (fake *FakeRoleServiceServer) AssignRoleToGroupReturns(result1 *protos.AssignRoleToGroupResponse, result2 error) {
...
func (fake *FakeRoleServiceServer) AssignRoleToGroupReturnsOnCall(i int, result1 *protos.AssignRoleToGroupResponse, result2 error) {
	fake.AssignRoleToGroupStub = nil
...
func (fake *FakeRoleServiceServer) UnassignRoleFromGroup(arg1 context.Context, arg2 *protos.UnassignRoleFromGroupRequest) (*protos.UnassignRoleFromGroupResponse, error) {
	...
	fake.recordInvocation("UnassignRoleFromGroup", []interface{}{arg1, arg2})
	fake.unassignRoleFromGroupMutex.Unlock()
	if fake.UnassignRoleFromGroupStub != nil {
		return fake.UnassignRoleFromGroupStub(arg1, arg2)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
...
func (fake *FakeRoleServiceServer) UnassignRoleFromGroupCallCount() int {
...
func (fake *FakeRoleServiceServer) UnassignRoleFromGroupArgsForCall(i int) (context.Context, *protos.UnassignRoleFromGroupRequest) {
	fake.unassignRoleFromGroupMutex.RLock()
	defer fake.unassignRoleFromGroupMutex.RUnlock()
	return fake.unassignRoleFromGroupArgsForCall[i].arg1, fake.unassignRoleFromGroupArgsForCall[i].arg2
}

func (fake *FakeRoleServiceServer) UnassignRoleFromGroupReturns(result1 *protos.UnassignRoleFromGroupResponse, result2 error) {
...
func (fake *FakeRoleServiceServer) UnassignRoleFromGroupReturnsOnCall(i int, result1 *protos.UnassignRoleFromGroupResponse, result2 error) {
	fake.UnassignRoleFromGroupStub = nil
